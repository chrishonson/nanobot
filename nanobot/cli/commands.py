...
def _make_provider(config: Config):
    ...
    try:
        from nanobot.perf import instrument_provider
...
def gateway(
    ...
    from nanobot.dashboard.server import DashboardManager
    dashboard_port = port + 1  # Dashboard on gateway port + 1 (e.g. 18791)
    dashboard = DashboardManager(agent, channels, cron, port=dashboard_port)
    console.print(f"[green]✓[/green] Dashboard: [cyan]http://127.0.0.1:{dashboard_port}[/cyan]")
