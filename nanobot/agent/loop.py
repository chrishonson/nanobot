...
class AgentLoop:
    ...
    def _register_default_tools(self) -> None:
        ...
        for cls in (WriteFileTool, EditFileTool, ListDirTool):
            self.tools.register(cls(workspace=self.workspace, allowed_dir=allowed_dir, extra_allowed_dirs=extra_paths or None))
        ...
        self.tools.register(CodingAgentTool(manager=self.subagents))
